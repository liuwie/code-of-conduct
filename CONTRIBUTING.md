...
1. Open in a new tab https://github.com/janmaghuyop/code-of-conduct
...
```
cd ~/Downloads
git clone git@github.com:username/code-of-conduct.git
cd code-of-conduct
```
...
```
git remote add upstream git@github.com:janmaghuyop/code-of-conduct.git
```
